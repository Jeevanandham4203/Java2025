...
public class UseMobile {
	...
	public static void main(String[] args) {
		...
		List<Mobile>skip1=phone.stream().sorted(Comparator.comparing(Mobile::getPrice).reversed()).limit(3).collect(Collectors.toList());
...
//		System.out.println(d2);
		...
		String findFirst2 = phone.stream().map(x->x.getBrand()).findFirst().get();
		System.out.println(findFirst2);
		Mobile findFirst = phone.stream().findFirst().get();
