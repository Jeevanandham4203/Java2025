...
public class UseEmployee {
	...
	public static void main(String[] args) {
		Employee e1 = new Employee("jeeva", 24, 3000, true, 3.0f);
		Employee e2 = new Employee("sharmi", 20, 4000, false, 2.0f);
		Employee e3 = new Employee("poovu", 25, 5000, true, 4.0f);
		Employee e4 = new Employee("karthi", 30, 4000, true, 4.5f);
		Employee e5 = new Employee("vino", 24, 4000, false, 1.5f);
		...
		emp.add(e4);
		emp.add(e5);
		Map<Boolean, Long> collect3 = emp.stream().collect(Collectors.groupingBy(x->x.isMale(),Collectors.counting()));
...
//		System.out.println(male);
		...
		System.out.println("To print if the exp more than 2yrs------->");
		List<Employee> collect = emp.stream().map(a->
		{
			if(a.getExp()>2) {
				a.setSalary(a.getSalary()+5);
			}
			return a;
		...
		System.out.println("--------->To print if the exp more than 2yrs------->");
		List<Employee> collect2 = emp.stream().filter(a->a.getExp()>2).map(a->
		{
			if(a.getExp()>2) {
				a.setSalary(a.getSalary()+5);
			}
